...
if (!fs.existsSync(envPath)) {
  // Multiple MongoDB connection options - default to MongoDB Atlas but with a more reliable cluster
...
FRONTEND_URL=http://localhost:3000`;
  ...
  console.log('.env file created with multiple MongoDB connection options');
